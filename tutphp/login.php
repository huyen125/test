     ...
     <div class="small-8">
       ...
       <div class="row">
         <div class="small-4 columns">
           <label for="right-label" class="right inline">Tài khoản</label>
         </div>
         <div class="small-8 columns">
           <input type="email" id="right-label" class="form" placeholder="abc@gmail.com" name="username">
         </div>
       </div>
       <br>
       <div class="row">
         <div class="small-4 columns">
           <label for="right-label">Mật khẩu</label>
         </div>
         <div class="small-8 columns">
           <input type="password" id="right-label" class="form" name="pwd">
         </div>
       </div>
       ...
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="submit" id="right-label" value="Đăng Nhập" class="login">
