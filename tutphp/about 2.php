		...
		<div id="menu">
			...
			<ul>
				<li class="active"><a href="index.php">Trang Chủ</a></li>
					...
					<li><a href="about.php" style="background-color: #b75914;">Giới Thiệu</a></li>
				</ul>
		</div>
		...
		<div id="page">
					...
					<div class="row">
						<div class="col-md-4">
							<ul class="info">
								...
								<li><span class="first-block">Website:</span><span class="second-block">www.phoenix.com</span></li>
			...
			<div id="fh5co-work" class="fh5co-bg-dark">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=1.3" class="work" style="background-image: url(imagesgioithieu/portfolio-1.jpg);">
							<div class="desc">
								<h3>Xiaomi</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=1.1" class="work" style="background-image: url(imagesgioithieu/portfolio-2.jpg);">
							<div class="desc">
								<h3>Áo Nam</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=1.4" class="work" style="background-image: url(imagesgioithieu/portfolio-7.jpg);">
							<div class="desc">
								<h3>Oppo</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=1.5" class="work" style="background-image: url(imagesgioithieu/portfolio-4.jpg);">
							<div class="desc">
								<h3>LG</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=2.3" class="work" style="background-image: url(imagesgioithieu/portfolio-5.jpg);">
							<div class="desc">
								<h3>Phụ kiện Xiaomi</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=2.2" class="work" style="background-image: url(imagesgioithieu/portfolio-6.jpg);">
							<div class="desc">
								<h3>Phụ kiện Samsung</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=2.4" class="work" style="background-image: url(imagesgioithieu/portfolio-3.jpg);">
							<div class="desc">
								<h3>Phụ kiện Oppo</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
						<div class="col-md-3 text-center col-padding animate-box"> <a href="/shop.php?id=2.5" class="work" style="background-image: url(imagesgioithieu/portfolio-8.jpg);">
							<div class="desc">
								<h3>Phụ kiện LG</h3>
								<span>Hình minh họa</span> </div>
							</a> </div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="fh5co-blog animate-box"> <a href="#" class="blog-bg" style="background-image: url(imagesgioithieu/portfolio-1.jpg);"></a>
								<div class="blog-text"> <span class="posted_on">Mar. 15th 2016</span>
									<h3><a href="/single-product.php?id=3">Quần Tây Nam</a></h3>
									...
									<ul class="stuff">
										...
										<li><a href="/single-product.php?id=3">Xem thêm<i class="icon-arrow-right22"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="fh5co-blog animate-box"> <a href="#" class="blog-bg" style="background-image: url(imagesgioithieu/portfolio-2.jpg);"></a>
								<div class="blog-text"> <span class="posted_on">Mar. 15th 2016</span>
									<h3><a href="/single-product.php?id=1">Sơ Mi Nam Sọc Xanh</a></h3>
									...
									<ul class="stuff">
										<li><i class="icon-heart2"></i>249</li>
										<li><i class="icon-eye2"></i>308</li>
										<li><a href="/single-product.php?id=1">Xem thêm<i class="icon-arrow-right22"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="fh5co-blog animate-box"> <a href="#" class="blog-bg" style="background-image: url(imagesgioithieu/portfolio-3.jpg);"></a>
								<div class="blog-text"> <span class="posted_on">Mar. 15th 2016</span>
									<h3><a href="/single-product.php?id=9">Phụ kiện Oppo Biti's Hunter</a></h3>
									...
									<ul class="stuff">
										<li><i class="icon-heart2"></i>249</li>
										<li><i class="icon-eye2"></i>308</li>
										<li><a href="/single-product.php?id=9">Xem thêm<i class="icon-arrow-right22"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                      ...
                      <ul>
                          ...
                          <li><a href="#">Email: nguyenhuyen98ttbn@gmail.com</a></li>
                          <li><a href="#">Trụ sở: Học viện công nghệ bưu chính viễn thông - Hà Nội</a></li>
                      </ul>
                    </div>
                </div>
