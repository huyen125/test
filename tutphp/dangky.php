...
<html lang="en">
 ...
 <form method="POST" action="insert.php" style="margin-left: 40%;margin-right: 40%; margin-top: 20px;">
   <div class="row">
     <div class="small-8">
       ...
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="text" id="right-label" name="fname" class="form">
         </div>
       </div>
       <br>
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="text" id="right-label" name="lname" class="form">
         </div>
       </div>
       <br>
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="text" id="right-label" placeholder="Hà Đông" name="address" class="form">
         </div>
       </div>
       <br>
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="text" id="right-label" placeholder="Hà Nội" name="city" class="form">
         </div>
       </div>
       <br>
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="email" id="right-label" placeholder="abc@gmail.com" name="email" class="form">
         </div>
       </div>
       <br>
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="password" id="right-label" name="pwd" class="form">
         </div>
       </div>
       <br>
       <div class="row">
         ...
         <div class="small-8 columns">
           <input type="submit" id="right-label" value="Đăng Ký" class="login">
           <input type="reset" id="right-label" value="Reset" class="reset">
         </div>
       </div>
     </div>
   </div>
             ...
             <div class="col-md-3 col-sm-6">
                 <div class="footer-menu">
                   ...
                   <ul>
                       ...
                       <li><a href="#">Trụ sở: Học viện công nghê bưu chính viễn thông- Hà Nội</a></li>
                   </ul>
                 </div>
             </div>
